PUZZLES.push(
  { id:51, title:"Puzzle 051", difficulty:"easy", groups:[
    { connection:"THE CURE SONGS", cards:["A Forest","Just Like Heaven","Lovesong","Pictures of You"] },
    { connection:"DURAN DURAN SONGS", cards:["Rio","Hungry Like the Wolf","The Reflex","Ordinary World"] },
    { connection:"1980s SYNTH-POP ACTS", cards:["Erasure","Pet Shop Boys","Yazoo","Orchestral Manoeuvres in the Dark"] },
    { connection:"1980s ALBUMS WITH ONE-WORD TITLES", cards:["Thriller","Purple Rain","Graceland","Hounds of Love"] }
  ]},
  { id:52, title:"Puzzle 052", difficulty:"easy", groups:[
    { connection:"DEPECHE MODE SONGS", cards:["People Are People","Master and Servant","Strangelove","Personal Jesus"] },
    { connection:"THE SMITHS SONGS", cards:["This Charming Man","Panic","Girlfriend in a Coma","How Soon Is Now?"] },
    { connection:"1980s FEMALE POP STARS", cards:["Cyndi Lauper","Whitney Houston","Belinda Carlisle","Kim Wilde"] },
    { connection:"BANDS FORMED IN MANCHESTER", cards:["New Order","The Smiths","The Stone Roses","Happy Mondays"] }
  ]},
  { id:53, title:"Puzzle 053", difficulty:"medium", groups:[
    { connection:"R.E.M. SONGS", cards:["Radio Free Europe","So. Central Rain","The One I Love","Stand"] },
    { connection:"TALKING HEADS SONGS", cards:["Once in a Lifetime","Burning Down the House","Road to Nowhere","And She Was"] },
    { connection:"1980s COLLEGE ROCK ACTS", cards:["The Replacements","Hüsker Dü","Violent Femmes","Camper Van Beethoven"] },
    { connection:"ATHENS, GEORGIA BANDS", cards:["R.E.M.","The B-52's","Pylon","Love Tractor"] }
  ]},
  ...
  { id:55, title:"Puzzle 055", difficulty:"easy", groups:[
    { connection:"U2 SONGS", cards:["Sunday Bloody Sunday","Pride (In the Name of Love)","With or Without You","Where the Streets Have No Name"] },
    { connection:"INXS SONGS", cards:["Original Sin","Need You Tonight","New Sensation","Never Tear Us Apart"] },
    { connection:"1980s AUSTRALIAN ACTS", cards:["Men at Work","Midnight Oil","Crowded House","The Church"] },
    { connection:"1980s IRISH ACTS", cards:["U2","The Pogues","Sinéad O'Connor","The Waterboys"] }
  ]},
  { id:56, title:"Puzzle 056", difficulty:"medium", groups:[
    { connection:"NEW ORDER SONGS", cards:["Blue Monday","Bizarre Love Triangle","True Faith","Temptation"] },
    { connection:"JOY DIVISION SONGS", cards:["Love Will Tear Us Apart","Atmosphere","Transmission","She's Lost Control"] },
    { connection:"FACTORY RECORDS ACTS", cards:["A Certain Ratio","Happy Mondays","The Durutti Column","Section 25"] },
    { connection:"1980s BANDS WITH TWO-WORD NAMES", cards:["Sonic Youth","Echo & the Bunnymen","Cocteau Twins","Prefab Sprout"] }
  ]},
  { id:57, title:"Puzzle 057", difficulty:"easy", groups:[
    { connection:"BRUCE SPRINGSTEEN SONGS", cards:["Hungry Heart","Dancing in the Dark","Glory Days","I'm on Fire"] },
    { connection:"BON JOVI SONGS", cards:["Runaway","You Give Love a Bad Name","Livin' on a Prayer","Wanted Dead or Alive"] },
    { connection:"NEW JERSEY ACTS", cards:["Bruce Springsteen","Bon Jovi","The Smithereens","Fugees"] },
    { connection:"1980s SONGS ABOUT WORK", cards:["Working for the Weekend","9 to 5","She Works Hard for the Money","Manic Monday"] }
  ]},
  { id:58, title:"Puzzle 058", difficulty:"medium", groups:[
    { connection:"THE CARS SONGS", cards:["Shake It Up","Drive","You Might Think","Magic"] },
    { connection:"THE POLICE SONGS", cards:["Don't Stand So Close to Me","Every Little Thing She Does Is Magic","Every Breath You Take","King of Pain"] },
    { connection:"1980s POWER POP ACTS", cards:["The Romantics","The Plimsouls","The dB's","Marshall Crenshaw"] },
    { connection:"1980s BANDS WITH VEHICLE-RELATED NAMES", cards:["The Cars","The Motels","The Railway Children","Transvision Vamp"] }
  ]},
  ...
  { id:64, title:"Puzzle 064", difficulty:"medium", groups:[
    ...
    { connection:"HÜSKER DÜ SONGS", cards:["Celebrated Summer","Makes No Sense at All","Don't Want to Know If You Are Lonely","Could You Be the One?"] },
    { connection:"MINNEAPOLIS 1980s ACTS", cards:["Prince","The Replacements","Hüsker Dü","Soul Asylum"] },
    { connection:"1980s ALBUMS PRODUCED BY JIMMY IOVINE", cards:["Making Movies","Bella Donna","Under a Blood Red Sky","Once Upon a Time"] }
  ]},
  ...
  { id:69, title:"Puzzle 069", difficulty:"medium", groups:[
    ...
    { connection:"THE JAM SONGS", cards:["Going Underground","Start!","Town Called Malice","That's Entertainment"] },
    { connection:"1980s BRITISH ALTERNATIVE ACTS", cards:["The The","The Fall","Wire","The Wedding Present"] },
    { connection:"BANDS WITH THREE-LETTER NAMES", cards:["XTC","ABC","INXS","REM"] }
  ]},
  ...
  { id:72, title:"Puzzle 072", difficulty:"easy", groups:[
    ...
    { connection:"ZZ TOP SONGS", cards:["Gimme All Your Lovin'","Sharp Dressed Man","Legs","Sleeping Bag"] },
    { connection:"1980s ROCK TRIOS", cards:["Rush","ZZ Top","The Police","Motörhead"] },
    { connection:"1980s SONGS WITH CLOTHING IN THE TITLE", cards:["You Can Leave Your Hat On","Raspberry Beret","Dress You Up","Blue Jean"] }
  ]},
  { id:73, title:"Puzzle 073", difficulty:"medium", groups:[
    { connection:"THE JESUS AND MARY CHAIN SONGS", cards:["Just Like Honey","April Skies","Head On","Happy When It Rains"] },
    { connection:"COCTEAU TWINS SONGS", cards:["Pearly-Dewdrops' Drops","Lorelei","Carolyn's Fingers","Heaven or Las Vegas"] },
    { connection:"4AD ACTS OF THE 1980s", cards:["Bauhaus","Dead Can Dance","Throwing Muses","Pixies"] },
    { connection:"1980s SCOTTISH ALTERNATIVE ACTS", cards:["The Jesus and Mary Chain","Cocteau Twins","The Blue Nile","Aztec Camera"] }
  ]},
